...
const SOCIAL_LINKS = [
  {
    name: 'Pouya Miralayi',
    link: 'https://github.com/pouyamiralayi/',
  },
  // {
  //   name: 'Slack',
        ...
        <div className="row">
          ...
          <div className="col-lg-4 col-md-4">
            <Block className={styles.blockShirt}>
              <div>
                <SupportUsTitle />
                <FormattedMessage id="تبلیغات برند یا توضیحات مربوط به برند در این قسمت قرار میگیرد">
                  {message => <p>{message}</p>}
                </FormattedMessage>
                <SupportUsCta />
              </div>
